...
\[
L(\theta) = L(x_1, x_2, \cdots, x_n; \theta) = \prod_{i=1}^{n}p(x_i;\theta), \theta \in \Theta. \tag{1.1}
\]
...
\[
L(x_1, x_2, \cdots, x_n; \hat{\theta}) = \max_{\theta \in \Theta} L(x_1, x_2, \cdots, x_n; \theta). \tag{1.2}
\]
...
\[
\frac{\partial}{\partial \theta_i} \ln L = 0, \, i = 1, 2, \cdots, k. \tag{1.7}
\]
...
**解** 记 \(x_{(1)}=\min\{x_1,x_2,\cdots,x_n\}, x_{(n)}=\max\{x_1,x_2,\cdots,x_n\}\)。\(X\) 的概率密度是
\[
f(x;a,b)=\begin{cases} 
